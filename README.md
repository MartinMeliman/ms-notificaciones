# ms-notificaciones — EcoTrade

Notificaciones transversales del sistema.
...
```
GET /api/notificaciones/usuario/{id}, POST /api/notificaciones/bienvenida, POST /api/notificaciones/pago, POST /api/notificaciones/envio, POST /api/notificaciones/pedido
```
...
| Remoto (Render) | https://ms-notificaciones-qx7k.onrender.com/swagger-ui.html |
...
```
https://ms-gateway-ndke.onrender.com/api/notificaciones
```
...
Desplegado en **Render**: https://ms-notificaciones-qx7k.onrender.com
